...
Author URI: http://www.maiq.info/
	Copyright (c) 2008 - 2010 maiq (http://www.maiq.info)
	MQ ReLinks is released under the GNU General Public
	License (GPL) http://www.gnu.org/licenses/gpl.txt
	This is a WordPress plugin (http://wordpress.org).
*/
	// variables for the fields and option names 
	$opt_name =array( 'replace_in_post', 'blank_in_post', 'replace_in_comment', 'blank_in_comment', 'replace_in_author_comment_link', 'blank_in_author_comment_link','mq_use_pretty_url');
	global $opt_name;
function mq_relinks_install(){
	...
	add_option('mq_use_pretty_url', 'yes');
	add_option('relink_path', 'wp-content/plugins/mq-relinks/');
}
...
if( function_exists( 'load_plugin_textdomain' ) ) {
			load_plugin_textdomain( 'mq_relinks', 'wp-content/plugins/wp-options-manager' );
}
	...
	if( $mq_relinks_options_value['relink_path'] =='') 	add_option('relink_path', 'wp-content/plugins/mq-relinks/');
...
if ($mq_relinks_options_value['mq_use_pretty_url'] =='yes'){
echo "bong";
}
...
<a href="https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=yomaichi@gmail.com&currency_code=EUR&amount=&return=&item_name=MQ Relinks plugin" target="_new"><img src="../wp-content/plugins/mq-relinks/donate.gif"></a>
<br>
...
function mq_ReLinks_replaceit_post($matches) {
	...
	if ($mq_relinks_options_value['blank_in_post'] =='yes'){ if (($local === false) &&  ($href{6}!="#") && ($href{7}!="#") ) $blank = 'target="_blank"';}
