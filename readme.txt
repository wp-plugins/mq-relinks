...
Inserts target="_blank" and rewrites all direct links in posts, comments and author links, to a out.php file.
...
http://www.maiq.info/out.php?url=http://www.wordpress.org/
To do so move the out.php to your wordpress root directory, go to the plugin administration page and delete the text from the "ReLinks out.php path" field.
...
1.I edited the "ReLinks out.php path" and moved the out.php file to the wordpress root directory but I get a 404 error. What do I do?

Deactivate and reactivate the plugin, then try again :)
...
3.How can I support this plugin?
